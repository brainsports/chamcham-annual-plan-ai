...
CATEGORY_NAME_MAP = {
    ...
    "지역사회연계": "지역사회연계",
    "지역연계프로그램": "지역사회연계", "지역연계 프로그램": "지역사회연계",
    "지역연계": "지역사회연계",
}


_TABLE_CATS = r'(?:교육|보호|문화|정서지원|지역사회연계|지역연계|기타)'
...
{feedback_schema_rows}
  ...
  "total_review_table": [
    ...
    {{"category": "아동평가", "content": "● **이용현황 분석**: 상세설명...\\n\\n● **발달성과 평가**: 상세설명...\\n\\n● **만족도 결과**: 상세설명..."}},
    {{"category": "프로그램평가", "content": "● **프로그램 운영실적**: 상세설명...\\n\\n● **목표달성 분석**: 상세설명...\\n\\n● **개선필요 사항**: 상세설명..."}},
    {{"category": "후원활동측면", "content": "● **후원현황 분석**: 상세설명...\\n\\n● **기업연계 성과**: 상세설명...\\n\\n● **네트워크 구축**: 상세설명..."}},
    {{"category": "환류방안", "content": "● **차년도 목표설정**: 상세설명...\\n\\n● **개선계획 수립**: 상세설명...\\n\\n● **실행방안 도출**: 상세설명..."}}
  ],
  "satisfaction_survey": {{
